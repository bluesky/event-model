...
class SingleRunDocumentRouter(DocumentRouter):
    ...
    def get_descriptor(self, doc: dict) -> dict:
...
def merge_event_pages(event_pages: Iterable[dict]) -> dict:
    """
...
def merge_datum_pages(datum_pages: Iterable) -> dict:
    """
...
def bulk_datum_to_datum_page(bulk_datum: dict) -> dict:
    """
